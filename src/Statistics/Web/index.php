...
$func = "\\streetlamp\\Statistics\\Modules\\".$func;
...
if(!function_exists($func))
{
    $func = "\\streetlamp\\Statistics\\Modules\\main";
}
...
if(empty($_GET['count']) && $ip_count = count(\streetlamp\Statistics\Lib\Cache::$ServerIpList))
{
